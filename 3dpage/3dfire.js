...
//하늘색
  function init() {
    const MODEL_PATH = 'https://doongebucket.s3.ap-northeast-2.amazonaws.com/fire_animation_final3.glb';
    const canvas = document.querySelector('#c');
    const backgroundColor = 0x9eb691;

    // Init the scene
    scene = new THREE.Scene();
    scene.background = new THREE.Color(backgroundColor);
    scene.fog = new THREE.FogExp2(0x9eb691, 0.018);
      ...
      function (gltf) {
        ...
        model.traverse(o => {
          ...
          if (o.isBone) {
            ...
            if (o.name === 'mixamorigSpine1') waist = o;
          }
          if (o.isMesh) {
            o.castShadow = true;
          ...
          if (o.isBone && o.name === 'mixamorigSpine1') { 
            waist = o;
          }
        });

        model.scale.set(4.3, 4.3, 4.8);
  ...
  const floorMaterial = new THREE.MeshPhongMaterial({ color: 0x8a9e7f, shininess: 0 });
